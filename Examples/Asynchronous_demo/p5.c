...
// *****************************************************************************************************************************************
int p5_out0_priority=0;
int p5_out0_msg_len=sizeof(int)/4;
...
// *
// *****************************************************************************************************************************************
// Channel send_channel_p5_to_p4 variable p5_out0
volatile int *p5_out0=(int *)NOC_PARAMETER_MAP(NOC_RNI_SEND_BASE(send_channel_p5_to_p4),0);
// Channel recv_channel_p5_from_p3 variable p5_in0
volatile int *p5_in0=(int *)NOC_PARAMETER_MAP(NOC_RNI_RECV_BASE(recv_channel_p5_from_p3),0);
volatile int *p5_in0_heartbeat=(int *)NOC_PARAMETER_MAP(NOC_RNI_RECV_BASE(recv_channel_p5_from_p3),sizeof(int)/4);
...
{
//	(*p5_out0)=0;
	NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p5_to_p4,p5_out0_priority,p5_out0_msg_len);
};
...
void p5_main(void)
{
     if (NOC_RNI_RECV_CHANNEL_STATUS(NOC_RNI_BASE,recv_channel_p5_from_p3)>0)
     {
	(*p5_out0)=(*p5_in0);
	NOC_RNI_SEND(NOC_RNI_BASE,send_channel_p5_to_p4,p5_out0_priority,p5_out0_msg_len);
               NOC_RNI_CLEAR_SYNCHRONIZER_FLAG(NOC_RNI_BASE,recv_channel_p5_from_p3);
     };
};
