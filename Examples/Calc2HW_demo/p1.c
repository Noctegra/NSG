...
int p1_out0_msg_len=sizeof(neuron_values)/4;
...
volatile neuron_values *p1_out0=(neuron_values *)NOC_PARAMETER_MAP(NOC_RNI_SEND_BASE(send_channel_p1_to_p2),0);
// Channel recv_channel_p1_from_p0 variable p1_in0
volatile neuron_values *p1_in0=(neuron_values *)NOC_PARAMETER_MAP(NOC_RNI_RECV_BASE(recv_channel_p1_from_p0),0);
volatile int *p1_in0_heartbeat=(int *)NOC_PARAMETER_MAP(NOC_RNI_RECV_BASE(recv_channel_p1_from_p0),sizeof(neuron_values)/4);
...
void p1_init(void)
{
	...
	p1_out0->n8=0.0;
	p1_out0->n9=0.0;
	NOC_RNI_SEND(NOC_RNI_BASE,p1_out0_priority,p1_pid,p2_pid,send_channel_p1_to_p2,p1_out0_msg_len);
};
